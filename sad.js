...
var array = {
    ...
    // var g = 0;
var liindex = 0;
//index of muisc is different for every page
for (var i = 10; i < 20; i++) {
    var title = array["song"][i]["name"];
    var audio = array["song"][i]["source"];
    var cover = array["song"][i]["image"];
    var singer = array["song"][i]["singer"];

    var d1 = document.getElementById('one');
    d1.insertAdjacentHTML('afterend', `<li li-index="${i}" class="list-one"onclick="clicked(this)"> <img class="image-song"src="${cover}"><h2 class="song-title">${title}</h2></li><hr>`);

}


function clicked(e) {
    var liindex = e.getAttribute("li-index");

    sessionStorage.setItem('liindex', `${liindex}`);
